...
export const EXCHANGE_CONFIGS: Record<string, ExchangeConfig> = {
  ...
  bitget: {
    ...
    logoUrl: '/exchange-logos/bitget.svg',
    supportsWebSocket: true,
    maker_fee: 0.1,
    taker_fee: 0.15,
    withdrawal_fee: {
  ...
  gate_io: {
    ...
    logoUrl: '/exchange-logos/gate_io.svg',
    supportsWebSocket: true,
    maker_fee: 0.2,
    taker_fee: 0.2,
    withdrawal_fee: {
  ...
  bitfinex: {
    ...
    logoUrl: '/exchange-logos/bitfinex.svg',
    supportsWebSocket: true,
    maker_fee: 0.1,
    taker_fee: 0.2,
    withdrawal_fee: {
  ...
  gemini: {
    ...
    logoUrl: '/exchange-logos/gemini.svg',
    supportsWebSocket: true,
    maker_fee: 0.25,
    taker_fee: 0.35,
    withdrawal_fee: {
  ...
  kraken: {
    ...
    logoUrl: '/exchange-logos/kraken.svg',
    supportsWebSocket: true,
    maker_fee: 0.16,
    taker_fee: 0.26,
    withdrawal_fee: {
  ...
  poloniex: {
    ...
    logoUrl: '/exchange-logos/poloniex.svg',
    supportsWebSocket: true,
    maker_fee: 0.15,
    taker_fee: 0.25,
    withdrawal_fee: {
  ...
  ascendex: {
    ...
    logoUrl: '/exchange-logos/ascendex.svg',
    supportsWebSocket: true,
    maker_fee: 0.1,
    taker_fee: 0.2,
    withdrawal_fee: {
  ...
  bitrue: {
    ...
    logoUrl: '/exchange-logos/bitrue.svg',
    supportsWebSocket: true,
    maker_fee: 0.098,
    taker_fee: 0.098,
    withdrawal_fee: {
  ...
  htx: {
    ...
    logoUrl: '/exchange-logos/htx.svg',
    supportsWebSocket: true,
    maker_fee: 0.2,
    taker_fee: 0.2,
    withdrawal_fee: {
  ...
  mexc_global: {
    ...
    logoUrl: '/exchange-logos/mexc.svg',
    supportsWebSocket: true,
    maker_fee: 0.2,
    taker_fee: 0.2,
    withdrawal_fee: {
